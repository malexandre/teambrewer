...
export const queryKeys = {
  ...
  heroes: (teamId: string, formatId?: string) => [teamId, "heroes", formatId ?? null] as const,
  ...
  deckCardObservations: (teamId: string, deckId: string) =>
    [teamId, "deck", deckId, "card-observations"] as const,

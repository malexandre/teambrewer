...
describe("AdminPage", () => {
  it("lets an instance-admin with no membership pick a team and manage its members", async () => {
    ...
    // The add-existing-member form is present and posts a username.
    await userEvent.type(screen.getByLabelText("Existing username"), "carol");
    await userEvent.click(screen.getByRole("button", { name: "Add member" }));
  });

  it("posts the typed username to the add-member endpoint", async () => {
